...
<div class="card page-card mb-4"><div class="card-body p-4">
    ...
    @forelse($archivedBatches as $batch)
        <div class="border rounded p-3 mb-2"><strong>{{ $batch->batch_name }}</strong> · {{ $batch->course }} · {{ $batch->test_type }}
